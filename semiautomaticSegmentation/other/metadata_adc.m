%% ==== CONFIGURATION ==========================================
rootDir = 'C:\Users\Usuario\Desktop\BIALYSTOK\DATASET INICIAL\ADC_GRUCZOLOWY-20210917T085730Z-001';

%% ==== INITIALISE STORAGE =====================================
records = []; 
%% ==== LIST SUBTYPES (GRUCZOLOWY) =======================
...
% Uses metadataadc and INCLUDES PET_MR with "Not available" fields
